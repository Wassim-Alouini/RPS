...
function match(){
    ...
    else if (choice ==2){document.getElementById("dis").style.backgroundImage = "url('res\Paper.png')"}
    else if (choice == 3){document.getElementById("dis").style.backgroundImage = "url('res\Scissors.png')"}
